...
virtual bool UpdateChannelData(std::shared_ptr<NPulseChannelCommon> channel, std::shared_ptr<UIPointer> pointer=0);

virtual bool UpdateSynapseData(std::shared_ptr<NPulseSynapseCommon> synapse, std::shared_ptr<UIPointer> pointer=0);
// --------------------------
