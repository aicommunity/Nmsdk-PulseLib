...
public:
 ...
 /// Режим работы (обучение, распознавание) нейрона:
 ...
 /// 0 - DendriticSumPotential - суммарное значение максимумов потенциалов со всех дендритов
 ...
 /// 0 - суммарное значение максимумов потенциалов со всех сегментов сомы
 ...
 /// Флаг включения DEBUG-логирования: подробный вывод шагов обучения
 /// (изменение длин дендритов, числа синапсов, переходы режимов и итераций)
...
protected:
 ...
 /// число синапсов соответствовало числу сегментов в дендритах
