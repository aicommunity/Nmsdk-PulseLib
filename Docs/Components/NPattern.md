...
**Класс**: `NPattern` — Компонент паттерна/образца.
**Регистрация**: `NPulseLibrary.cpp` → `UploadClass("NPattern", ...)`.
**Storage**: `ClassName = "NPattern"`.
...
## NPattern — EN
Class `NPattern` — Компонент паттерна/образца.
