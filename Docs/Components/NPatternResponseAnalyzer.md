...
Нужный критерий эксперимента: один target-спайк после реального последнего стимула, отсутствие любых foil-спайков за одинаковый полный интервал наблюдения. После исправлений A01–A06 analyzer и metrics v2 это обеспечивают; historical CSV без повторного моделирования не восстанавливают потерянные late-спайки. [Аудит и after-fixes](../../../../Docs/Audit/TimeLearner-2026-09-22/README.md).
