## NPSynapseBio — био импульсный синапс

**Класс**: `NPSynapseBio` — Импульсный синапс с био-параметрами.
**Регистрация**: `NPulseLibrary.cpp` → `UploadClass("NPSynapseBio", ...)`.
**Storage**: `ClassName = "NPSynapseBio"`.
...
## NPSynapseBio — EN
Class `NPSynapseBio` — Импульсный синапс с био-параметрами.
