## NPNeuron — пульсовый нейрон (базовый)

**Класс**: `NPNeuron` — Базовый пульсовый нейрон.
**Регистрация**: `NPulseLibrary.cpp` → `UploadClass("NPNeuron", ...)`.
**Storage**: `ClassName = "NPNeuron"`.
...
## NPNeuron — EN
Class `NPNeuron` — Базовый пульсовый нейрон.
