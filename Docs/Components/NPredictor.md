...
**Класс**: `NPredictor` — Предсказатель сигналов/состояний.
**Регистрация**: `NPulseLibrary.cpp` → `UploadClass("NPredictor", ...)`.
**Storage**: `ClassName = "NPredictor"`.
...
## NPredictor — EN
Class `NPredictor` — Предсказатель сигналов/состояний.
