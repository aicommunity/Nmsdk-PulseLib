## NPac — счётчик/активатор (pulse)

**Класс**: `NPac` — Компонент Pac для подсчёта/активности.
**Регистрация**: `NPulseLibrary.cpp` → `UploadClass("NPac", ...)`.
**Storage**: `ClassName = "NPac"`.
...
## NPac — EN
Class `NPac` — Компонент Pac для подсчёта/активности.
