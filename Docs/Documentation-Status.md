...
**Аудит 2026-09-22:** [отчёт](../../../Docs/Audit/TimeLearner-2026-09-22/README.md). Сверены изменённые алгоритмы, метрики и локальные Markdown-ссылки. Статистика 2026-06-06 ниже является исторической; она не означает семантическую проверку всех компонентов текущего HEAD.
